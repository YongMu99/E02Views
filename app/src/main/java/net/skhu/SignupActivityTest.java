        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String email = editText_email.getText().toString();
                    ...
                    Toast.makeText(SignupActivityTest.this, msg, Toast.LENGTH_LONG).show();
                Intent intent = new Intent(SignupActivityTest.this, MemoActivityTest.class);
                startActivity(intent); // 회원가입 클릭시 메모장 이동
            }
        };
