...
public class MemoActivityTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String title = editText_title.getText().toString();//Editable 리턴 을 toString()으로 바꿔준다.
                ...
                Toast.makeText(MemoActivityTest.this, msg, Toast.LENGTH_LONG).show();
            }
        };
